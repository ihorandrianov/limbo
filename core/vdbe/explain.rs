use crate::vdbe::{builder::CursorType, StringValue};
    ...
    let (opcode, p1, p2, p3, p4, p5, comment): (&str, i32, i32, i32, OwnedValue, u16, String) =
        match insn {
            ...
            Insn::VUpdate {
                ...
                *arg_count as i32,
                *start_reg as i32,
                OwnedValue::Text(StringValue::Heap(format!("vtab:{}", vtab_ptr).into())),
                *conflict_action,
            ...
            Insn::String8 { value, dest } => (
                ...
                *dest as i32,
                0,
                OwnedValue::Text(StringValue::Heap(value.clone().into())),
                0,
                format!("r[{}]='{}'", dest, value),
            ),
            ...
            Insn::AggStep {
                ...
                *col as i32,
                *acc_reg as i32,
                OwnedValue::Text(StringValue::Heap(func.to_string().into())),
                0,
            ...
            Insn::SorterOpen {
                ...
                (
                    ...
                    *columns as i32,
                    0,
                    OwnedValue::Text(StringValue::Heap(
                        format!("k({},{})", order.len(), to_print.join(",")).into(),
                    )),
                    0,
                ...
                *dest as i32,
                {
                    ...
                    OwnedValue::Text(StringValue::Heap(s.into()))
                },
                0,
                if func.arg_count == 0 {
                    format!("r[{}]=func()", dest)
            ...
            Insn::Destroy {
                ...
                *is_temp as i32,
                OwnedValue::Text(StringValue::Heap("".into())),
                0,
                format!(
            ...
            Insn::ParseSchema { db, where_clause } => (
                ...
                *db as i32,
                0,
                0,
                OwnedValue::Text(StringValue::Heap(where_clause.clone().into())),
                0,
                where_clause.clone(),
            ),
            Insn::LastAwait { .. } => (
